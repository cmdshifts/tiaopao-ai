        ...
        <div className="bg-background">
          <div className="relative container mx-auto px-4 py-16 max-w-7xl">
            ...
            <div className="mx-auto mt-16 grid max-w-sm grid-cols-1 gap-6 text-gray-500 md:max-w-3xl md:grid-cols-2 xl:grid-rows-2 md:grid-rows-3 xl:max-w-6xl xl:auto-rows-fr xl:grid-cols-3">
              <motion.div
                className="group relative items-start overflow-hidden bg-gray-500/5 dark:bg-gray-000 p-6 rounded-2xl hover:bg-turquoise/10 transition-all duration-500 ease-out"
                variants={{
                  hidden: { opacity: 0, y: 200 },
                  visible: { opacity: 1, y: 0 },
                }}
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-primary">
                    สร้างแผนการท่องเที่ยวส่วนบุคคลแบบอัตโนมัติด้วย Magic Planner
                  </h3>
                  <p className="text-foreground dark:text-gray-400">
                    วางแผนการท่องเที่ยวตามความสนใจและความต้องการเฉพาะบุคคล
                    เพียงกรอกข้อมูลแล้ว AI จะสร้างแผนที่เหมาะสมให้ทันที
                  </p>
                </div>
                <svg
                  width="1203"
                  ...
                  <g clipPath="url(#path0)">
                    <path
                      ...
                      className="fill-[#E5E5E5] dark:fill-[#404040]"></path>
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                    ...
                    <path
                      ...
                      className="fill-white dark:fill-[#262626]"></path>
                    <circle
                      cx="27"
                      cy="25"
                      r="6"
                      className="fill-[#E5E5E5] dark:fill-[#404040]"></circle>
                    <circle
                      cx="47"
                      cy="25"
                      r="6"
                    ...
                    <image
                      ...
                      clipPath="url(#roundedBottom)"></image>
                  </g>
                  <defs>
                    <clipPath id="path0">
                      <rect
              ...
              <motion.div
                className="group relative items-start overflow-hidden bg-gray-500/5 dark:bg-gray-000 hover:bg-turquoise/10 p-6 rounded-2xl order-3 xl:order-none transition-all duration-500 ease-out"
                variants={{
                  hidden: { opacity: 0, y: 200 },
                  visible: { opacity: 1, y: 0 },
                }}
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-primary">
                    สำรวจแผนการท่องเที่ยวที่ผู้อื่นสร้างไว้ เพื่อรับแรงบันดาลใจ
                  </h3>
                  <p className="text-foreground dark:text-gray-400">
                    เข้าชมแผนการท่องเที่ยวที่คนอื่นสร้าง ค้นหาไอเดียใหม่ ๆ
                    เพื่อรับแรงบันดาลใจ สำหรับการท่องเที่ยวของคุณ
                  </p>
                </div>
                <svg
                  width="1203"
              ...
              <motion.div
                className="group relative items-start overflow-hidden bg-gray-500/5 dark:bg-gray-000 p-6 rounded-2xl hover:bg-turquoise/10 md:row-span-2 transition-all duration-500 ease-out"
                variants={{
                  hidden: { opacity: 0, y: 200 },
                  visible: { opacity: 1, y: 0 },
                }}
                ...
                <div>
                  ...
                  <p className="text-foreground dark:text-gray-400">
                    จัดการข้อมูลโปรไฟล์ เช่น ชื่อ, ภาพประจำตัว และรายละเอียดอื่น
                    ๆ ที่ช่วยให้โปรไฟล์ของคุณดูสมบูรณ์และเป็นระเบียบ
                  </p>
                </div>
                <canvas
              ...
              <motion.div
                className="group relative items-start overflow-hidden bg-gray-500/5 dark:bg-gray-000 p-6 rounded-2xl hover:bg-turquoise/10 flex-row order-4 md:col-span-2 md:flex-row xl:order-none transition-all duration-500 ease-out"
                variants={{
                  hidden: { opacity: 0, y: 200 },
                  visible: { opacity: 1, y: 0 },
                }}
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-primary">
                    แนะนำสถานที่ท่องเที่ยวใหม่ ๆ ที่น่าสนใจ
                  </h3>
                  <p className="text-foreground dark:text-gray-400">
                    รับการแนะนำสถานที่ท่องเที่ยวที่น่าสนใจ
                    พร้อมข้อมูลที่ทันสมัยที่สุด
                  </p>
                </div>
                <svg
                  width="1203"
